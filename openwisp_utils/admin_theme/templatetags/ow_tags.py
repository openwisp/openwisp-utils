...
def _render_single_filter(cl, spec, total_filters):
...
def ow_render_filters(cl, filter_specs):
    ...
    for parent in parent_filters:
        ...
        if children:
            ...
            output.append(_render_single_filter(cl, parent, total_filters))
            output.append('<div class="ow-sub-filter-group">')
            for child in children:
                output.append(_render_single_filter(cl, child, total_filters))
            output.append("</div>")
            output.append("</div>")
        else:
            output.append(_render_single_filter(cl, parent, total_filters))
