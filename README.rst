...
If ``True``, attaches markdown rendered HTML of message in email.
If ``False``, HTML rendering of message will be disabled and a plain
text email is sent.
...
This setting takes the URL of the logo to be displayed on email.
